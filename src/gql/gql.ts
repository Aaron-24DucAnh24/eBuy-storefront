...
const documents = {
	...
	'mutation InitializeAyden($checkoutId: ID!) {\n  paymentGatewayInitialize(\n    id: $checkoutId\n    paymentGateways: [{id: "app.saleor.adyen"}]\n  ) {\n    gatewayConfigs {\n      id\n      data\n      errors {\n        field\n        message\n        code\n      }\n    }\n    errors {\n      field\n      message\n      code\n    }\n  }\n}':
		types.InitializeAydenDocument,
 ...
 */
export function graphql(
	source: 'mutation InitializeAyden($checkoutId: ID!) {\n  paymentGatewayInitialize(\n    id: $checkoutId\n    paymentGateways: [{id: "app.saleor.adyen"}]\n  ) {\n    gatewayConfigs {\n      id\n      data\n      errors {\n        field\n        message\n        code\n      }\n    }\n    errors {\n      field\n      message\n      code\n    }\n  }\n}',
): typeof import("./graphql").InitializeAydenDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
	source: "query ProductListPaginated($first: Int!, $after: String, $channel: String!) {\n  products(first: $first, after: $after, channel: $channel) {\n    totalCount\n    edges {\n      node {\n        ...ProductListItem\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}",
): typeof import("./graphql").ProductListPaginatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query SearchProducts($search: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $first: Int!, $after: String, $channel: String!) {\n  products(\n    first: $first\n    after: $after\n    channel: $channel\n    sortBy: {field: $sortBy, direction: $sortDirection}\n    filter: {search: $search}\n  ) {\n    totalCount\n    edges {\n      node {\n        ...ProductListItem\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}",
